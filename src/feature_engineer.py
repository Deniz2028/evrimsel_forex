...
# -*- coding: utf-8 -*-
"""
EVO_FX_MASTER - Düzeltilmiş Gelişmiş Özellik Mühendisliği Modülü
==============================================================
...
- **HATA DÜZELTİLDİ**: EMA crossover hesaplama sırası düzeltildi
"""
...
class AdvancedFeatureEngineer:
    ...
    def calculate_advanced_technical_indicators(self, df: pd.DataFrame) -> pd.DataFrame:
        """
        **DÜZELTME**: Gelişmiş teknik indikatörler - 30+ indikatör.
        EMA crossover hesaplama sırası düzeltildi.
        ...
        # **DÜZELTME**: Moving averages'ları ÖNCE hesapla
        ma_periods = [5, 10, 12, 20, 26, 50, 100, 200]  # 12 ve 26 eklendi
        ...
        # **DÜZELTME**: MA crossover signals (artık EMA'lar mevcut)
        ...
        # MACD family (EMA 12 ve 26 artık mevcut)
    ...
    def bake_features_advanced(self, symbol: str, df: pd.DataFrame = None) -> Optional[pd.DataFrame]:
        ...
        # 2. **DÜZELTME**: Advanced technical indicators (30+) - sıra düzeltildi
...
def main():
    """Test fonksiyonu."""
    logger.info("🔧 DÜZELTME: AdvancedFeatureEngineer modülü test ediliyor...")
    ...
    # **DÜZELTME**: Gelişmiş feature engineering test
    logger.info("🔧 DÜZELTME: Gelişmiş feature engineering testi...")
    featured_data = engineer.bake_features_advanced('TEST', test_data)
    
    if featured_data is not None:
        logger.info(f"✅ DÜZELTME başarılı!")
        ...
        # **DÜZELTME KONTROLLERİ**: Sorunlu sütunları kontrol et
        critical_features = ['ema_12', 'ema_26', 'macd', 'macd_signal']
        logger.info("🔍 Kritik özellikler kontrol ediliyor:")
        for feature in critical_features:
            if feature in featured_data.columns:
                logger.info(f"  ✅ {feature}: MEVCUT")
            else:
                logger.error(f"  ❌ {feature}: EKSİK!")
        ...
        important_features = [
            ...
            'ema_12', 'ema_26', 'macd'  # Düzeltilen özellikler
        ]
        ...
        logger.error("❌ Gelişmiş feature engineering testi hala başarısız!")
    
    logger.info("✅ DÜZELTME: AdvancedFeatureEngineer modülü test tamamlandı!")
